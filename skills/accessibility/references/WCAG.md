...
| **3.3.7** Redundant Entry | Don't require re-entry of info already provided in the same process |
...
| **2.4.11** Focus Not Obscured (Minimum) | Focused element is at least partially visible, not hidden behind sticky content |
| **2.5.7** Dragging Movements | Drag actions have a single-pointer alternative (unless essential) |
| **2.5.8** Target Size (Minimum) | Pointer targets are at least 24×24 CSS pixels, or have sufficient spacing |
...
| **3.3.8** Accessible Authentication (Minimum) | No cognitive function test required for login unless alternative provided |
...
| **2.4.12** Focus Not Obscured (Enhanced) | Focused element is fully visible, no part hidden by author content |
| **2.4.13** Focus Appearance | Focus indicator has ≥ 3:1 contrast and ≥ 2px perimeter area |
...
| **3.3.9** Accessible Authentication (Enhanced) | No cognitive function test for login, including object recognition |
...
| Change | Details |
|--------|---------|
| **Removed** 4.1.1 Parsing | Obsolete — browsers now handle malformed HTML; valid HTML is still a best practice |
| **New A** 3.2.6, 3.3.7 | Consistent Help, Redundant Entry |
| **New AA** 2.4.11, 2.5.7, 2.5.8, 3.3.8 | Focus Not Obscured, Dragging Movements, Target Size, Accessible Authentication |
| **New AAA** 2.4.12, 2.4.13, 3.3.9 | Focus Not Obscured (Enhanced), Focus Appearance, Accessible Authentication (Enhanced) |
